...
For more complex setups (e.g. for workers) you can also pass your arg directly to synapse using `run` mode. For example like this:
...
## Using Double Puppeting
Please have a look at the [devture/matrix-synapse-shared-secret-auth configuring chapter](https://github.com/devture/matrix-synapse-shared-secret-auth#Configuring)
